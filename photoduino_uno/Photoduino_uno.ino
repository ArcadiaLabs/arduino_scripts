 ...
 *
 * @modded by   https://plus.google.com/112719719919184066558/posts
...
/* ------------------------------------------------------------------------------------------------ *
 *                                         MODDED BY CaptainStouf                                   *
 *                                      FOR ARDUINO UNO ON A BREADBOARD                             *
...
// - SENSOR_TYPE_SHOCK
//
#define DEFAULT_SENSOR_TYPE                     SENSOR_TYPE_LIGHT
...
#define SIGNATURE_CODE1             08 // day 
#define SIGNATURE_CODE2             6  // month
#define SIGNATURE_CODE3             20 // century
#define SIGNATURE_CODE4             14 // year of century
...
#define DEFAULT_system_useFlash1                      false  // (HWL MOD)
#define DEFAULT_system_useFlash2                      false  // (HWL MOD)
...
// Pinout settings
#define PINS_LCD_LED         14 //(digital pin) // (HWL MOD)
...
#define PINS_SENSOR_MIC      3  //(analog pin)
  ...
  #define PINS_DEVICE        13 //(digital pin) // (HWL MOD)
#endif
